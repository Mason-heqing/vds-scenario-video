...
export default {
  ...
  methods: {
    ...
    getTopInfo(){
      ...
      res => {
        ...
        if (res.code == 200) {
           ...
           this.specialPackageLimitParallelTotalNum = res.data.specialPackageLimitParallelTotalNum;
          ...
          console.log(
            "#####sss:",
            res.data.specialPackageLimitParallelTotalNum
          );
        }
    ...
    chartParallelPackageRate() {
       console.log(
         this.specialPackageParallelTotalNum,
         this.specialPackageLimitParallelTotalNum
      );
        let maySpecialPackageTotalNum = Math.floor(this.specialPackageParallelTotalNum / this.specialPackageLimitParallelTotalNum);
