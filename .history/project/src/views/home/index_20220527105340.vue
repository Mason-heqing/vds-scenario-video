  <template>
    <div class="content-wrapper home">
      ...
      <section class="content container-fluid">
        <div class="row wrapper-boox" v-loading="loading">
          <div class="col-lg-3 col-xs-6 wrapper_top" style="padding-right:0px;">
            ...
            <div class="small-box bg-aqua" style="background: #4994E8 !important" >
              <div class="inner" >
                <div>
                  <h3>
                    <span id="companyTotal">{{specialPackageTotalNum}}</span>
                  </h3>
                  <p>有效专线包</p>
                </div>
              </div>
              ...
              <div class="small-box-footer" @click="$router.push('/poolSpecialized')">
                <span id="companyOutMothTotal">无效专线包：{{specialPackageInvalidTotalNum}} 个</span>
                <span id="companyInMothTotal" style="margin-left:5px !important;">未使用专线包：{{specialPackageUnuseTotalNum}} 个</span>
              </div>
            </div>
          </div>
          <!-- ./col -->
          <div class="col-lg-3 col-xs-6 wrapper_top" style="padding-right:0px;padding-left: 15px !important">
            ...
            <div class="small-box bg-yellow" style="background: #58C7CF !important ;">
              <div class="inner">
                <div>
                  <h3>
                    <span id="personTotal">{{videoActivatePackageNum}}</span>
                  </h3>
                  <p>剩余激活包</p>
                </div>
              </div>
              ...
              <div class="small-box-footer">
                <span id="companyInMothTotal">购买总数: {{videoActivatePackageTotalNum}} 个</span>
                <span id="companyOutMothTotal" style="margin-left:5px !important;">已使用总数：{{videoActivatePackageUseNum}} 个</span>
              </div>
            </div>
          </div>
          ...
          <div class="col-lg-3 col-xs-6  wrapper_top" style="">
            ...
            <div class="small-box bg-green" style="background:#5FBB5F !important;">
              <div class="inner">
                <div>
                  <h3>
                    <span id="totalDeviceTotalSpan">{{deviceTotalNum}}</span>
                  </h3>
                  <p>设备总数</p>
                </div>
              </div>
              <div class="icon">
                ...
                <div class="small-box-footer">
                <span id="companyInMothTotal">在线数：{{deviceOnlineNum}}台</span>
                <!-- <span id="companyOutMothTotal" style="margin-left:5px !important;">视频播放数：{{devicePlayVideoNum}}台</span> -->
              </div>
            </div>
          </div>
          ...
          <div class="col-lg-3 col-xs-6  wrapper_top" style="">
            <!-- small box -->
            <div class="small-box bg-green" style="background: #879BD7 !important;">
              <div class="inner" >
                <div>
                  <h3>
                    <span id="totalDeviceTotalSpan">{{specialPackageParallelTotalNum}}</span>
                  </h3>
                  <p>正在播放(路)</p>
                </div>
              </div>
              <div class="icon">
                ...
                <div class="small-box-footer">
                <span id="companyInMothTotal">同时播放总路数限制: {{specialPackageLimitParallelTotalNum}}</span>
              </div>
            </div>
          </div>
        ...
        <div class="row">
          <div class="col-lg-12 col-xs-12 pr-20">
            <div class="row" v-loading="loading1">
              <div class="col-lg-3 col-md-12" style="padding-right:0px">
                <div class="box">
                  ...
                  <div class="box-body">
                    <div class="row">
                      <div class="col-md-12">
                        <div
                          class="chart"
                          ref="chartParallelPackageResourcePool"
                          style="height: 300px;padding-right: 10px"
                        ></div>
                      </div>
                    </div>
            ...
            <!-- <div class="row" v-loading="loading2">
              <div class="col-lg-3 col-md-12" style="padding-right:0px">
                <div class="box">
                  <div class="box-header with-border" style="height:42px">
                    <h3 class="box-title select-date">
            ...
            <div class="row" >
                ...
                <div class="row">
                  ...
                  <div class="box-header with-border" style="height:42px">
                    <h3 class="box-title select-date">
                      <span>实时视频播放客户端统计</span>
                    </h3>
                    <span id="person_title_text"></span>
                  </div>
                  <div class="box-body" v-loading="loading3">
                    <div class="row">
                      <div class="col-md-12">
                        <div
                          class="chart"
