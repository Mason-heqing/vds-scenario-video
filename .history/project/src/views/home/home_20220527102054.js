...
export default {
  ...
  methods: {
    ...
    chartParallelPackageRate() {
       console.log(
         "百分比:",
         this.maySpecialPackageTotalNum /
           (this.maySpecialPackageTotalNum + this.mayNotSpecialPackageTotalNum)
      );
        console.log((350 / (350 + 270)*100).tofixed(2));
       this.pieSpecialPackage = this.$echarts.init( this.$refs.chartSpecialPackageRate ); 
      if ( this.pieSpecialPackage) {
