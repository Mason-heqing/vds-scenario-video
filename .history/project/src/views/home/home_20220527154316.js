...
export default {
  ...
  methods: {
        ...
        if (res.code == 200) {
          ...
          this.$nextTick( () => {
            ...
            this.specialPackageParallelTotalNum =
              res.data.specialPackageParallelTotalNum || 0;
            this.specialPackageLimitParallelTotalNum =
              res.data.specialPackageLimitParallelTotalNum || 0;
          })
    ...
    chartParallelPackageRate() {
      ...
      console.log("专线包总理率",maySpecialPackageTotalNum);
