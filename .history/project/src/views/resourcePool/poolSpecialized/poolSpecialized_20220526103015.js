...
export default {
  ...
  methods: {
    ...
    //添加专线池包
    addParallel( value ) {
      if (9 === this.tableLabel1.length) {
        this.tableLabel1.splice( 8, 1 );
      }
      this.tableLabel1 = tableLabel;
      this.resourcePoolId = value;
      this.isShowSelect1 = true;
      this.isOperate = true;
      console.log(this.tableLabel1);
    ...
    editPackageSpecialized( id ) {
      if (8 === this.tableLabel1.length) {
        this.tableLabel1.push({ slot: "operate", isshow: true });
      }
      this.getDedicatedPoollist();
