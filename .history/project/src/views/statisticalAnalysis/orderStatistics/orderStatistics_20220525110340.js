  ...
  methods: {
        ...
        // }
              */
              ...
              res.data.forEach( ( item, index ) => {
                ...
                if (index == 0) {
                item.statList.forEach((item, index) => {
                    let secHeaderJson = {};
                    secHeaderJson.orderDay = item.orderDay;
                    secHeaderJson.speciaName = "专线包";
                    secHeaderJson.activateName = "激活包";
                    secHeaderJson.spciaNameParam = item.orderDay + "specialTotalPrice";
                    secHeaderJson.activateParam = item.orderDay + "activateTotalPrice";
                    secHeaderColumn.push( secHeaderJson );
                    
                  json[ item.orderDay + "specialTotalPrice" ] = item.specialTotalPrice;
                  json[item.orderDay + "activateTotalPrice"] = item.activateTotalPrice;
                 });
                }
                tableData.push(json);
              })
    ...
    /*
      tableLabel: [
        ...
        // { label: '时长包(元)', param: 'durationTotalPrice', align: 'left', sortable: true, isshow: true},
        { label: '专线包', param: 'specialTotalPrice', align: 'left', sortable:"custom", isshow: true},
        { label: '激活包', param: 'activateTotalPrice', align: 'left', sortable:"custom", isshow: true},
