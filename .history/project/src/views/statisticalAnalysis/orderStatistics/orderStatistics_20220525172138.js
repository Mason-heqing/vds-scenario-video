...
export default {
  ...
  data() {
    return {
      ...
      tableLabel: [
        { label: '机构', param: 'orgName', align: 'left', sortable:"custom", isshow: true,width:120},
        { label: '时间', param: 'dateStr', align: 'left', sortable:"custom", isshow: true,width:75},
        // { label: '时长包(元)', param: 'durationTotalPrice', align: 'left', sortable: true, isshow: true,width:75},
        { label: '专线包', param: 'specialTotalPrice', align: 'left', sortable:"custom", isshow: true,width:75},
        { label: '激活包', param: 'activateTotalPrice', align: 'left', sortable:"custom", isshow: true,width:75},
        { label: '合计', param: 'totalPrice', align: 'left', sortable:"custom", isshow: true},
      ],
      tableOption: [],
      tableSelect: [],
      leftData: [], //左边侧边栏数据
        ...
        res => {
          ...
          if ( res.code == 200 ) {
            if ( res.data && res.data.length ) {
              ...
              console.log("时间表:", this.timesList);
              console.log("统计表数据:", this.pieShowData);
              console.log("机构数据:", this.orgList);
            } else {
                this.secHeaderData = [];
                this.tableData = []; 
                this.timesList = []; 
