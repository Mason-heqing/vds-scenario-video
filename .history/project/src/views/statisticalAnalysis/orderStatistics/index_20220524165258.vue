                  ...
                  <div class="form-horizontal">
                    ...
                    <div class="col-lg-3 pl-0">
                      <div class="form-group">
                        ...
                        <div
                          class="col-md-12"
                          v-else-if="2 === dataForm.operateType"
                        >
                          <el-date-picker
              ...
              <el-table-column label="后果" :resizable="false">
                ...
                >
                  <template slot-scope="scope">
                    <div
                      class="table_item"
                      :style="customState(scope.row.level_1)"
                    >
                      {{ scope.row.level_1 }}
                    </div>
                  </template>
                ...
                >
                  <template slot-scope="scope">
                    <div
                      class="table_item"
                      :style="customState(scope.row.level_2)"
                    >
                      {{ scope.row.level_2 }}
                    </div>
                  </template>
                ...
                >
                  <template slot-scope="scope">
                    <div
                      class="table_item"
                      :style="customState(scope.row.level_3)"
                    >
                      {{ scope.row.level_3 }}
                    </div>
                  </template>
                ...
                >
                  <template slot-scope="scope">
                    <div
                      class="table_item"
                      :style="customState(scope.row.level_4)"
                    >
                      {{ scope.row.level_4 }}
                    </div>
                  </template>
                ...
                >
                  <template slot-scope="scope">
                    <div
                      class="table_item"
                      :style="customState(scope.row.level_5)"
                    >
                      {{ scope.row.level_5 }}
                    </div>
                  </template>
