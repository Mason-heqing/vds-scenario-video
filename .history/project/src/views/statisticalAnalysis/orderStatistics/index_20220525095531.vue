                ...
                <el-table
                  ...
                  <el-table-column
                    ...
                    width="150">
                      ...
                      <el-table-column :label="item.orderDay" v-for="(item,index) in tableLabel[1].secHeaderData" :key="index">
                          <el-table-column v-if="'专线包' == item.speciaName"
                            prop="specialTotalPrice"
                            :label="item.speciaName"
                            width="120">
                          </el-table-column>
                          <el-table-column v-if="'激活包' == item.speciaName"
