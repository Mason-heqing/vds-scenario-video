<template>
  <div class="content-wrapper">
    ...
    <el-dialog :title="isCreate ? '创建专线包资源池' : '编辑专线包资源池'" :visible.sync="dialogVisible" width="32%" class="pool-dialog">
        <el-form ref="poolForm" :model="poolForm" label-width="200px" :rules="rules">
