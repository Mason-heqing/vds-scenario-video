<template>
  <div class="content-wrapper">
    ...
    <el-dialog :title="isCreate ? '创建专线包资源池' : '编辑专线包资源池'" :visible.sync="dialogVisible" width="20%" class="pool-dialog">
        <el-form ref="poolForm" :model="poolForm" label-width="110px" :rules="rules">
        ...
        <el-form-item label="客户端播放数" prop="limitParallelNumPerDevice">
            <el-input v-model="poolForm.limitParallelNumPerDevice" onkeyup="value=value.replace(/[^\d]/g,'')" placeholder="请输入客户端播放数"></el-input>
        </el-form-item>
      </el-form>
      <span slot="footer" class="dialog-footer">
