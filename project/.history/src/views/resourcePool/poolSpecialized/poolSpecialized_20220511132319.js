  ...
  data() {
    ...
    return {
      ...
      tableLabel: [
        ...
        { label: '机构数', param: 'orgNum', align: 'center', sortable: true ,isshow:true,width:'100'},
        { label: '项目(车场)数', param: 'appNum', align: 'center',isshow:true, sortable: true,width:'120'},
        {slot:'editPackageNum',isshow:true},
        // { label: '专线包个数', param: 'packageNum', align: 'center',isshow:true, sortable: true ,width:'100'},
        {slot:'devicesNum',isshow:true},
        // { label: '设备数', param: 'deviceNumDesc', align: 'center',isshow:true, sortable: true ,width:'100'},
        {slot:'parallelNum',isshow:true},
		    // { label: '专线包个数', param: 'parallelNumDesc', align: 'center',isshow:true, sortable: true ,width:'100'},
      ...
      tableData1:[],//专线包列表
      tableLabel1: [
        { label: 'ID', param: 'id', align: 'center', sortable: true ,isshow:true,width:'120'},
      ...
      tableData2:[],
      tableLabel2:[
        { label: '机构', param: 'orgId', align: 'center', sortable: true ,isshow:true,width:'80'},
        { label: '项目(车场)', param: 'appName', align: 'center', sortable: true ,isshow:true,width:'80'},
        { label: '设备序列号', param: 'deviceSn', align: 'center',isshow:true, sortable: true,width:'80'},
        { label: '设备名称', param: 'deviceName', align: 'center',isshow:true, sortable: true ,width:'120'},
        { label: '总播放时长', param: 'playSeconds', align: 'center', isshow: true, sortable: true, width: '80' },
        {slot:'online',isshow:true},
		    // { label: '播放状态', param: 'playing', align: 'center',isshow:true, sortable: true ,width:'80'},
        { label: '播流客户端', param: 'playClientNum', align: 'center', isshow: true, sortable: true, width: '80' },
        { slot: 'operate',isshow:true }, // 操作列
      ],
      isShowSelect2:true,
      currentPage2:1,
      ...
      tableData5: [],
      tableLabel5: [
        { label: '设备名称', param: 'name', align: 'left', sortable: true ,isshow:true,width:'80'},
        { label: '设备S/N', param: 'serial', align: 'left',isshow:true, sortable: true,width:'80'},
        { label: 'IP', param: 'ip', align: 'left',isshow:true, sortable: true ,width:'120'},
        // { label: '视频流', param: 'playSeconds', align: 'center',isshow:true, sortable: true ,width:'80'},
		    { label: '软件版本', param: 'protocolVersion', align: 'center',isshow:true, sortable: true ,width:'80'},
        { label: '状态', param: 'online', align: 'center',isshow:true, sortable: true ,width:'80'},
      ],
      isShowSelect5: true,
      currentPage5: 1,
      total5:0,
