  ...
  data() {
    return {
      ...
      tableLabel: [
        ...
        { label: '创建时间', param: 'createTime', align: 'center', sortable: true, isshow: true,width:'100'},
        { label: '产品类型', param: 'categoryName', align: 'center', sortable: true, isshow: true,width:'100'},
        { label: '规格', param: 'specificationDesc', align: 'center', sortable: true, isshow: true,width:'80'},
        { label: '数量', param: 'quantity', align: 'center', sortable: true,isshow:true,width:'100'},
        { label: '总价(元)', param: 'totalPrice', align: 'left', sortable: true,isshow:true,width:'90'},
        { label: '支付状态', param: 'paidDesc', align: 'center', sortable: true, isshow: true,width:'90'},
