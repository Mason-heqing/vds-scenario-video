...
export default {
  ...
  data() {
    return {
      ...
      tableLabel: [
        { label: 'orderId', param: 'orderId', align: 'left', sortable: false, isshow: true,width:'100'},
        { label: '创建时间', param: 'createTime', align: 'left', sortable: true, isshow: true,width:'100'},
        { label: '产品类型', param: 'categoryName', align: 'left', sortable: true, isshow: true,width:'100'},
        { label: '规格', param: 'specificationDesc', align: 'left', sortable: true, isshow: true,width:'80'},
        { label: '数量', param: 'quantity', align: 'left', sortable: true,isshow:true,width:'100'},
        { label: '总价(元)', param: 'totalPrice', align: 'left', sortable: true,isshow:true,width:'90'},
        { label: '支付状态', param: 'paidDesc', align: 'left', sortable: true, isshow: true,width:'90'},
