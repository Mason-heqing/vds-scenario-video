          ...
          <div class="col-lg-3 col-xs-6 wrapper_top" style="padding-right:0px;">
            ...
            <div class="small-box bg-aqua" style="background: #4994E8 !important" >
              ...
              <div class="small-box-footer" @click="$router.push('/poolSpecialized')">
                <span id="companyInMothTotal">专线总数：{{specialPoolNum}} 个</span>
                <span id="companyOutMothTotal" style="margin-left:5px !important;">当前用量：{{specialPackageUseNum}} 个</span>
              </div>
            </div>
          </div>
          <!-- ./col -->
          ...
          <div class="col-lg-3 col-xs-6  wrapper_top" style="">
            ...
            <div class="small-box bg-green" style="background: #EF985A !important;">
              <div class="inner" >
                <div>
                  <h3>
                    <span id="totalDeviceTotalSpan">{{totalPrice}}</span>
                  </h3>
                  <p>消费金额</p>
                </div>
              </div>
              <div class="icon">
                ...
                <div class="small-box-footer">
                <span id="companyInMothTotal">本账户购买: {{parentPrice}}元</span>
                <span id="companyOutMothTotal" style="margin-left:5px !important;">下属账户消费: {{childPrice}}元</span>
              </div>
            </div>
          </div>
                  ...
                  <div class="box-body">
                    <div class="row">
                      <div class="col-md-12">
                        <div
                          class="chart"
                          id="chartParallelPackageResourcePool"
                          style="height: 300px;padding-right: 10px"
                        ></div>
                      </div>
                    </div>
