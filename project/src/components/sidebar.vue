  ...
  <aside class="main-sidebar">
    ...
    <section class="sidebar">
      ...
      <ul class="sidebar-menu" data-widget="tree">
         <!-- <li class="">
           <router-link to="/" class="router-link-active active">
          ...
          <li class="treeview">
            <router-link to="/alarmrecord" class="nav-link">
        ...
        <li
          ...
          :key="index"
          :class="[{'active':item.selected,'menu-open':item.selected}]"
...
export default {
  ...
  created() {
    ...
    ligature.$on('userId',(id)=>{
      this.userImg = this.tools.global.API_URL + '/user/photo?id='+id
    })
  ...
  methods: {
    ...
    getLeftMenu() {
      ...
      this.utils.http(
        {
          url: "/menu/get?scenario=" + scenario,
          method: "GET",
          // login:true,
          params: {}
        },
