    ...
    <section class="content container-fluid">
      <div class="box box-primary">
        <div class="box-body">
          <div class="form-horizontal">
            <div class="col-sm-4 pl-0">
              <div class="form-group">
                <div class="col-md-12">
                  <button id="btn_add_special" type="button" class="btn btn-primary" @click="addSpecial">
                    购买专线包
                  </button>
                  <button id="btn_add_activate" type="button" class="btn btn-primary" @click="addActivate">
                    购买车牌相机视频上云激活包
                  </button>                  
            ...
            <div class="col-sm-8 text-right p-0 flex-style">
              <div class="col-lg-2">
                <div class="form-group">
                  <div class="col-md-12">
                    <el-select clearable="" v-model="dataForm.category" placeholder="选择产品类别">
          ...
          <table-cmp v-loading="loading" :table-data="listData" :table-label="tableLabel" ref="tableChild"  @sortableChange="sortableChange"
            :is-show-select="isShowSelect">
            <el-table-column slot="operate" label="操作" align="center" width="150" v-if="!isMaster">
              <template slot-scope="scope">
                <el-row>
                  <el-button v-show="0 === scope.row.paid" title="支付" type="primary" icon="el-icon-shopping-cart-full"
                    round size="mini" @click="goEdit(scope.row.orderId)"></el-button>
    ...
    <el-dialog title="创建订单" :visible.sync="dialogVisible" width="45%">
      <el-tabs v-model="activeNamePaytype" type="border-card" @tab-click="handleClick">
        ...
        <el-tab-pane label="专线包" name="second">
            ...
            <el-col :span="19">
              <el-radio-group v-model="payTimes" @change="radioChangePayTimes">
                <el-radio-button :label="item.id" v-for="(item, index) in specialSubsetItem" :key="index">
                  {{ item.durationDesc }}</el-radio-button>
              </el-radio-group>
            </el-col>
          </el-row>
          <el-row align="middle" class="mt-10">
          ...
          <el-row align="middle" class="mt-10">
            <el-col :span="5" class="text-right pr-20">可绑设备数</el-col>
        ...
        <el-tab-pane label="车牌相机视频上云激活包" name="third">
          <el-row align="middle">
            <el-col :span="5" class="text-right pr-20">购买数量</el-col>
            <el-col :span="19">
              <el-input v-model.number="activePackAgeNum" placeholder="请输入购买数量" style="width:50%;"
                onkeyup="value=value.replace(/[^\d]/g,'')" @change="changeActiveNumTimes"></el-input> 个
            </el-col>
          </el-row>
          <el-row align="middle" class="mt-10">
            <el-col :span="5" class="text-right pr-20">总价</el-col>
          ...
          <el-row align="middle" class="mt-10">
            <el-col :span="5" class="text-right pr-20">备注</el-col>
            <el-col :span="19" class="red">
              <span>一个激活包可供一台车牌识别相机视频上云。</span>
            </el-col>
          </el-row>          
        </el-tab-pane>
      </el-tabs>
